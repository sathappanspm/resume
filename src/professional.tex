...
\begin{itemize}
  ...
  \ressubheading{Virginia Tech}{Arlington, VA}{GRA, Discovery Analytics 
      ...
      \begin{itemize}
          \resitem{Worked on  Civil Unrest Forecasting for IARPA funded EMBERS-``Early Model Based Event
          ...
          over EMBERS AWS cluster framework}
          \resitem{Collaborated with several institutes such as NDSSL,
