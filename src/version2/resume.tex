...
%This is specific for NLP positions
\header{Summary}
...
% Experienced with working on big data, time series and text mining.
% Broadly interested in forecasting, text mining / Applied NLP, machine learning,
% and data science.
